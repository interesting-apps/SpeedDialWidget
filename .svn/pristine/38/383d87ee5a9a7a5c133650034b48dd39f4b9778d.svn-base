...
public class SpeedDialWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context,
		...
		for (int widgetId : allWidgetIds) {
			...
			updateRemoteViews(context, remoteViews, allWidgetIds);

			appWidgetManager.updateAppWidget(widgetId, remoteViews);
		}
	}

	private static Intent createNumpadIntent(Context context,
			int[] allWidgetIds,
			String digit) {
	...
	private static void assignMakeCallActivity(Context context,
	...
	private static void assignCallLogActivity(Context context, RemoteViews remoteViews) {
